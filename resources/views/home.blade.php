                    ...
                    <div class="form-group">
                      <select id="surat" name="tpl" class="form-control selectpicker" data-live-search="true" title="Pilih Jenis Surat" >
                       ...
                       <label class="control-label" for="kepada">Kepada</label>
                            <input name="kepada" id="kepada" type="text" class="form-control" placeholder="Masukkan penerima surat"/>
                      </div>
                      ...
                      <div class="form-group" >
                       <label class="control-label" for="NIP">NIP</label>
                            <input name="NIP1" id="NIP1" type="text" class="form-control" placeholder="Masukkan NIP"/>
                      </div>
                      <div class="form-group" id="grpnip2">
                       <label class="control-label" for="NIP2">NIP</label>
                            <input name="NIP2" id="NIP2" type="text" class="form-control" placeholder="Masukkan NIP"/>
                      </div>
                      <div class="form-group" id="grpnip3">
                       <label class="control-label" for="NIP3">NIP</label>
                            <input name="NIP3" id="NIP3" type="text" class="form-control" placeholder="Masukkan NIP"/>
                      </div>
                      <div class="form-group" id="grpnip4">
                       <label class="control-label" for="NIP4">NIP</label>
                            <input name="NIP4" id="NIP3" type="text" class="form-control" placeholder="Masukkan NIP"/>
                      </div>
                      <div class="form-group" id="grpnip5">
                       <label class="control-label" for="NIP5">NIP</label>
                            <input name="NIP5" id="NIP5" type="text" class="form-control" placeholder="Masukkan NIP"/>
                      </div>
                      <div class="form-group" id="grpnip6">
                       <label class="control-label" for="NIP6">NIP</label>
                            <input name="NIP6" id="NIP6" type="text" class="form-control" placeholder="Masukkan NIP"/>
                      </div>
                      <div class="form-group" id="grpnip7">
                       <label class="control-label" for="NIP7">NIP</label>
                            <input name="NIP7" id="NIP7" type="text" class="form-control" placeholder="Masukkan NIP"/>
                      </div>
                      <div class="form-group" id="grpnip8">
                       <label class="control-label" for="NIP8">NIP</label>
                            <input name="NIP8" id="NIP8" type="text" class="form-control" placeholder="Masukkan NIP"/>
                      </div>
                      <div class="form-group" id="grpnip9">
                       <label class="control-label" for="NIP9">NIP</label>
                            <input name="NIP9" id="NIP9" type="text" class="form-control" placeholder="Masukkan NIP"/>
                      </div>
                      <div class="form-group" id="grpnip10">
                       <label class="control-label" for="NIP10">NIP</label>
                            <input name="NIP10" id="NIP10" type="text" class="form-control" placeholder="Masukkan NIP"/>
                      </div>
